/datum/map_generator/jungle_generator_eden
...
/datum/map_generator/jungle_generator_eden/generate_terrain(list/turfs)
	. = ..()
	...
	for(var/t in turfs) //Go through all the turfs and generate them
		...
		if(height <= 0.85) //If height is less than 0.85, we generate biomes based on the heat and humidity of the area.
			...
			selected_biome = /datum/biome/eden_mountain
...
/area/mine/planetgeneration/eden
	...
	map_generator = /datum/map_generator/jungle_generator_eden
